<template>
  <main class="main-view-container">
    <header class="page-header cyber-panel">
      <h1 class="chrome-text">Primary</h1>
      <p class="subtitle digital-label">I Am a Child of God</p>
    </header>

    <section class="calendar-section">
      <HomeCalendar filterTag="Primary" />
      <UpcomingEvents filterTag="Primary" />
    </section>
