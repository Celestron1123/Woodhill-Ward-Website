<template>
  <main class="main-view-container">
    <header class="page-header cyber-panel">
      <h1 class="chrome-text">Elders Quorum</h1>
      <p class="subtitle digital-label">Brethren in Christ</p>
    </header>

    <section class="calendar-section">
      <HomeCalendar filterTag="Elders Quorum" />
      <UpcomingEvents filterTag="Elders Quorum" />
    </section>
    ...
    <section class="social-section">
      <GroupSocial :tags="['eldersquorum', 'eq']" />
    </section>
