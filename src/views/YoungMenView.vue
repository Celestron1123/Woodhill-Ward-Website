<template>
  <main class="main-view-container">
    <header class="page-header cyber-panel">
      <h1 class="chrome-text">Young Men</h1>
      <p class="subtitle digital-label">Duty to God</p>
    </header>

    <section class="calendar-section">
      <HomeCalendar filterTag="Young Men" />
      <UpcomingEvents filterTag="Young Men" />
    </section>
