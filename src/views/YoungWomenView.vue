<template>
  <main class="main-view-container">
    <header class="page-header cyber-panel">
      <h1 class="chrome-text">Young Women</h1>
      <p class="subtitle digital-label">Strive to be worthy</p>
    </header>

    <section class="calendar-section">
      <HomeCalendar filterTag="Young Women" />
      <UpcomingEvents filterTag="Young Women" />
    </section>
