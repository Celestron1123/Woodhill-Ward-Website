                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td><input id="announcement-title" type="text" v-model="form.title" placeholder="Announcement Title" /></td>
                        </tr>
                        <tr>
                            <td><label for="announcement-content">Content:</label></td>
                            <td><textarea id="announcement-content" v-model="form.content" placeholder="Details of the announcement..."></textarea></td>
                        </tr>
                    </tbody>
                </table>
